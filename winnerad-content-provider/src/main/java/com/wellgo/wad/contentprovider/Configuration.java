...
public class Configuration {
    ...
    public final static Integer LISTEN_PORT = 8080; // 4000 + new Random().nextInt(2999);
    ...
    public static final String EB_ADDR_CONTENT_GENERATOR = "content.generator";
    
    public static final String EB_ADDR_CONTENT_STORAGE = "content.storage";
}
